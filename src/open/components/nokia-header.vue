  ...
  <div class="nokia-header has-video" :style="{ backgroundImage: this.getImage() }">
    <div id="nokia-header-video" v-if="this.video == 1">
      <div class="nokia-header__video-wrapper">
        ...
        <video playsinline autoplay muted loop poster="/themes/custom/nokiavue/images/video_cover.jpg" id="bgvid" style="position: absolute;left: 0;top: 0;">
            <source src="/themes/custom/nokiavue/videos/oen_home.mp4" type="video/mp4">
            <source src="/themes/custom/nokiavue/videos/oen_home.webm" type="video/webm">
        </video>
